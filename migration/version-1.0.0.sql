...
CREATE TABLE IF NOT EXISTS "booking" (
    ...
    CONSTRAINT "FK_BOOKING_VOUCHER_CODE" FOREIGN KEY ("voucher_code") REFERENCES "promotion" ("promotion_code"),
    CONSTRAINT "FK_BOOKING_COUPON_CODE" FOREIGN KEY ("coupon_code") REFERENCES "promotion" ("promotion_code"),
